    ...
    try {
      ...
      const activities = [
        ...(recentFees.data?.map(fee => ({
          id: fee.id,
          type: 'fee',
          description: `دفعة جديدة من ${fee.student?.full_name || 'طالب'}`,
          amount: fee.amount,
              ...
              <div className="hidden md:flex items-center gap-3">
                <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-xl">
                  ...
                  <span className="text-sm font-medium text-gray-700">
                    {formatNumber(stats.totalRevenue)} ج.م
                  </span>
                </div>
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl">
                  ...
                  <span className="text-sm font-medium text-gray-700">
                    {formatNumber(stats.totalExpenses)} ج.م
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="hidden md:flex gap-4">
                  <div className="text-center">
                    <p className="text-4xl font-bold">{stats.activeStudents}</p>
                    <p className="text-sm text-white/80">طالب نشط</p>
                  </div>
                  <div className="w-px h-12 bg-white/20"></div>
                  <div className="text-center">
                    <p className="text-4xl font-bold">{stats.activeTeachers}</p>
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white rounded-xl shadow-md p-6 border-r-4 border-purple-600 hover:shadow-lg transition-all transform hover:-translate-y-1">
                    ...
                    <div className="mt-2 text-sm text-gray-600">
                      إجمالي الرواتب: {formatNumber(stats.totalSalaries)} ج.م
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className={`p-3 rounded-full ${
                      ...
                      {stats.netProfit >= 0 ? (
                        ...
                        <TrendingDown className={`w-6 h-6 ${stats.netProfit >= 0 ? 'text-green-600' : 'text-red-600'}`} />
                      )}
                    </div>
                  </div>
                  ...
                  <div className={`text-4xl font-bold mb-4 ${
                    ...
                    {stats.netProfit >= 0 ? '+' : ''}{formatNumber(stats.netProfit)} ج.م
                  </div>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div 
                        className={`h-full ${stats.netProfit >= 0 ? 'bg-green-600' : 'bg-red-600'}`}
                        style={{ 
                          width: `${stats.totalRevenue > 0 
                            ? Math.min(100, Math.abs((stats.netProfit / stats.totalRevenue) * 100))
                            : 0}%` 
                        }}
                      />
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      ...
                      <div className="flex items-center justify-between mt-3">
                        ...
                        <span className="text-sm font-medium text-blue-600">
                          {formatNumber(stats.totalRevenue)} / 100,000 ج.م
                        </span>
                      </div>
                    </div>
                  </div>
